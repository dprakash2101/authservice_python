...
from authservice.configuration import Configuration
from authservice.api_response import ApiResponse, T as ApiResponseT
import authservice.models
from authservice import rest
from authservice.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(authservice.models, klass)
